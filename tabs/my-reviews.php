...
<?php endif; ?>
<button type="button" id="ti-btn-instant-manual-download" class="button button-primary button-hero" style="background:#10b981; border-color:#10b981; color:#fff; font-weight:700; padding:12px 24px; border-radius:6px; cursor:pointer; font-size:15px; margin-bottom:20px; box-shadow:0 4px 6px -1px rgba(16,185,129,0.3);">
⚡ Download / Sync New Reviews Now
</button>
<script>
document.addEventListener('DOMContentLoaded', function() {
    var btn = document.getElementById('ti-btn-instant-manual-download');
    if (btn) {
        btn.addEventListener('click', function(e) {
            e.preventDefault();
            btn.innerText = 'Syncing Reviews...';
